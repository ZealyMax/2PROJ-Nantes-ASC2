...
$(".btn-add").on('click', function () {
    ...
    <div class=question-div>  <br>  <br>     \
        <button ondrop=drop(event) ondragover=allowDrop(event) >" + i + "</button> \
...
$(document).on('click', '.add-choice', function () {
    ...
    <div>\
        ...
        <input type=radio><input name=sub_questions[] placeholder=Option><button class=rm-div>X</button>\
...
$(document).on('click', '.add-check', function () {
    ...
    <div>\
        ...
        <input type=checkbox><input name=sub_questions[] placeholder=Option><button class=rm-div>X</button>\
...
$(document).on('click', '.add-column-multiple', function () {
    ...
    <div>\
        ...
        <input type=radio><input name=sub_questions[] placeholder=Colonne><button class=rm-div>X</button>\
...
$(document).on('click', '.add-column-checkbox', function () {
    ...
    <div>\
        ...
        <input type=checkbox><input name=sub_questions[] placeholder=Colonne><button class=rm-div>X</button>\
...
$(document).on('change', 'select', function () {
    ...
    if ($(this).children('option:selected').val() == "multiple") {
        $(this).parent(".question-div").children(".question-content").html("<input name=sub_questions[] type=hidden value='radio'>\
                                                                            <input type=radio><input name=sub_questions[] placeholder=Option><br><button class=add-choice>Ajouter</button>");
    }
    if ($(this).children('option:selected').val() == "checkbox") {
        $(this).parent(".question-div").children(".question-content").html("<input name=sub_questions[] type=hidden value='checkbox'>\
                                                                            <input type=checkbox><input name=sub_questions[] placeholder=Option><br><button class=add-check>Ajouter</button>");
    }
    ...
    if ($(this).children('option:selected').val() == "grid-multiple") {
        $(this).parent(".question-div").children(".question-content").html("<div class=line>\
                                                                            ...
                                                                            <div class=column>\
                                                                                <input name=sub_questions[] type=hidden value='column-multiple'>\
                                                                                <input type=radio><input name=sub_questions[] placeholder=Colonne><button class=add-column-multiple>Ajouter</button>\
                                                                            </div>");
    }
    if ($(this).children('option:selected').val() == "grid-checkbox") {
        $(this).parent(".question-div").children(".question-content").html("<div class=line>\
                                                                            ...
                                                                            <div class=column>\
                                                                                <input name=sub_questions[] type=hidden value='column-checkbox'>\
                                                                                <input type=checkbox><input name=sub_questions[] placeholder=Colonne><button class=add-column-checkbox>Ajouter</button>\
                                                                            </div>");
    }
